...
'''
PUSH_TOKEN = "aaf9375c622e4a16b871ff1621b80037" #os.environ.get("PUSHPLUS_KEY")
...
'''
AMAP_KEY = "89691373270d3b49158d0318d36a227b" # os.environ.get("GAODE_KEY")
...
'''
PRIVATE_AES_KEY = "312028"#os.environ.get("PRIVATE_AES_KEY")
